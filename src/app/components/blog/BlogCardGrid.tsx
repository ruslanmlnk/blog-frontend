        ...
        >
          ...
          <div className="py-[35px] px-4">
            {it.avatar ? (
              ...
              it.dateLabel && (
                <div className="text-[12px] font-bold text-[#767676] mb-[25px] leading-[8px] uppercase">
                  {it.dateLabel}
                </div>
              )
            )}
            ...
            <h3 className="font-bold text-base leading-[160%] mb-[25px]">
              <Link href={it.href}>
                {it.title.length > 112 ? `${it.title.slice(0, 112)}...` : it.title}
              </Link>
            </h3>

            {it.description && (
              <p className="text-[#767676] text-base leading-[22px] tracking-[-0.4px]">
                {it.description.length > 75 ? `${it.description.slice(0, 75)}...` : it.description}
              </p>
            )}
